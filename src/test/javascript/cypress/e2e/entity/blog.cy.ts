...
describe('Blog e2e test', () => {
  ...
  const blogSample = { name: 'criminal', handle: 'absent whereas' };
  ...
  describe('new Blog page', () => {
    ...
    it('should create an instance of Blog', () => {
      cy.get(`[data-cy="name"]`).type('traffic');
      cy.get(`[data-cy="name"]`).should('have.value', 'traffic');

      cy.get(`[data-cy="handle"]`).type('gracefully during tensely');
      cy.get(`[data-cy="handle"]`).should('have.value', 'gracefully during tensely');
