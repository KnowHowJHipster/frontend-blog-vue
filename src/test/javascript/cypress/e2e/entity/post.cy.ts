...
describe('Post e2e test', () => {
  ...
  const postSample = { title: 'after', content: 'Li4vZmFrZS1kYXRhL2Jsb2IvaGlwc3Rlci50eHQ=', date: '2024-06-03T05:26:01.394Z' };
  ...
  describe('new Post page', () => {
    ...
    it('should create an instance of Post', () => {
      cy.get(`[data-cy="title"]`).type('off backburn');
      cy.get(`[data-cy="title"]`).should('have.value', 'off backburn');
      ...
      cy.get(`[data-cy="date"]`).type('2024-06-03T06:25');
      cy.get(`[data-cy="date"]`).blur();
      cy.get(`[data-cy="date"]`).should('have.value', '2024-06-03T06:25');
